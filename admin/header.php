...
if(isset($_COOKIE["type"]))
{
 ?>
	<div class="col-md-3 col-sm-12 text-right">
							<ul class="nav-icons">
								<li><a href="profile.php"><i class="ion-person"></i><div>สำหรับเจ้าหน้าที่</div></a></li>
 ...
 <?php }else{ ?>
	...
	<div class="col-md-3 col-sm-12 text-right">
							<ul class="nav-icons">
								<li><a href="#"><i class="ion-person"></i><div>สำหรับเจ้าหน้าที่</div></a></li>
				...
				<div class="container">
					...
					<div id="menu-list">
						<ul class="nav-list">
							...
							<li><a href="#">ดูข้อมูลนักศึกษา</a></li>
							<li><a href="#">ดาวน์โหลดฐานข้อมูล</a></li>
							<li><a href="#">ติดต่อผู้พัฒนา</a></li>
						</ul>
					</div>
				</div>
			</nav>
